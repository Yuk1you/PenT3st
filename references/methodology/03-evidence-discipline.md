...
> 视角：报漏洞之前，确保你说的每一句都站得住，甲方安全团队能复现得了
...
| **资产归属幻觉** | "我以为是该公司的资产" | 资产不在授权范围，写入报告即违规 |

> 没有证据支撑的结论会拖累整份报告的可信度——甲方会连带怀疑那些证据扎实的条目，得不偿失。
...
| **XSS** | 弹窗截图 + URL bar / 配合 XSS Hunter 等回调平台收到 callback |
...
P0/P1 漏洞，附 30s–2min 录屏极大提升报告可信度与复现确认速度。
...
- [ ] 域名 / IP 在 Phase 1 确认的授权范围内（核对授权书/合同附件的资产清单）
